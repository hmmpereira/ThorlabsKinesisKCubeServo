///////////////////////////////////////////////////////////////////////////////
// FILE:          ThorlabsKinesisKCubeServo.h
...
class ThorlabsKinesisKCubeServo : public CStageBase<ThorlabsKinesisKCubeServo>
{
public:
	ThorlabsKinesisKCubeServo();
	ThorlabsKinesisKCubeServo(std::string deviceName,  long chNumber);
	~ThorlabsKinesisKCubeServo();
	...
	int OnTrigMode1(MM::PropertyBase* pProp, MM::ActionType eAct);
	int OnTrigMode2(MM::PropertyBase* pProp, MM::ActionType eAct);
	int OnTrigPolarity1(MM::PropertyBase* pProp, MM::ActionType eAct);
	int OnTrigPolarity2(MM::PropertyBase* pProp, MM::ActionType eAct);
	//int OnTrigMove(MM::PropertyBase* pProp, MM::ActionType eAct);
	int OnTrigDir(MM::PropertyBase* pProp, MM::ActionType eAct);
...
private:
	...
	KMOT_TriggerPortMode kmot1;
	KMOT_TriggerPortMode kmot2;
	KMOT_TriggerPortPolarity pol1;
	KMOT_TriggerPortPolarity pol2;
	int pol_1;
	int pol_2;
	int trigPolarity_;
};
